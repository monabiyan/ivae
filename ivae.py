...
#############################################################
    def __init__(self,df_XY=None,reconst_coef=100000,kl_coef=0.001*512,classifier_coef=1000):
        ##########
        ...
        IVAE_ARCH.__init__(self,self.input_size)
        MyDataset.__init__(self,df=self.df_XY)
        self.organize_data()
#############################################################
    def model_initialiaze(self):
        self.model=IVAE_ARCH(self.input_size).to(device)
        self.train_tracker=[]
        self.test_tracker=[]
